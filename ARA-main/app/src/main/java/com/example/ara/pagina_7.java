...
public class pagina_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pagina_7);  // Layout correcto

        // Inicializamos los botones de respuesta
        Button respuestaA = findViewById(R.id.checkBox24); // Respuesta incorrecta
        Button respuestaB = findViewById(R.id.checkBox25); // Respuesta incorrecta
        Button respuestaC = findViewById(R.id.checkBox26); // Respuesta correcta
        Button respuestaD = findViewById(R.id.checkBox27); // Respuesta incorrecta
    ...
    private void verificarRespuesta(boolean esCorrecta) {
        if (esCorrecta) {
            ...
            Intent intent = new Intent(pagina_7.this, pagina_8.class); // Cambia a la página siguiente
